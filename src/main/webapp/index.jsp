...
<c:when test="${empty name}" >
    <button type="button" class="btn btn-success" onclick="location.href='http://localhost:8080/login'">Login</button>
    <button type="button" class="btn btn-success" onclick="location.href='http://localhost:8080/signup'">Signup</button>
</c:when>
    <c:otherwise>
