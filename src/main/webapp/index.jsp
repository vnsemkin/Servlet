...
<c:choose>
    <c:when test="${empty name}">
        ...
        <button type="button" class="btn btn-success" onclick="location.href='/signup'">Signup</button>
    </c:when>
    <c:otherwise>
        <button type="button" class="btn btn-success" onclick="location.href='/logout'">Logout
        </button>
    </c:otherwise>
</c:choose>
</body>
